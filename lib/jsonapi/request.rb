...
module JSONAPI
  class Request
    ...
    def initialize(params = nil, options = {})
      ...
      @custom_action_type = @params[:custom_action_type]
    ...
    def parse_custom_collection_operation(data)
      ...
      Array.wrap(data).each do |params|
        ...
        @operations.push JSONAPI::CustomCollectionActionOperation.new(
          @resource_klass,
          @custom_action_name,
          context: @context,
          data: data
    ...
    def unformat_value(attribute, value, resource_klass)
      resource_klass ||= @resource_klass
